...
class TestScoring:
    def test_high_quality_passes(self):
        content = {
            "title": "Why you should never ignore this secret",
            "hook_text": "Why you should never ignore this secret?",
            "body_text": "This is a detailed guide about how to improve your productivity " * 10,
            "cta_type": "direct",
            "offer_id": "abc",
    ...
    def test_trust_risk_blocked(self):
        content = {
            "title": "Test",
            "hook_text": "GUARANTEED 100% risk-free get rich instant results",
            "body_text": "guaranteed 100% risk-free miracle results",
            "platform": "tiktok",
            "content_type": "short_video",
        }
    ...
    def test_fatigue_penalizes(self):
        content = {
            "title": "Test?",
            "hook_text": "Why this secret?",
            "body_text": "Some body text here for testing",
            "platform": "tiktok",
            "content_type": "short_video",
        }
    ...
    def test_novelty_penalizes_similar(self):
        ...
        with_similar = score_content(
            content, {"recent_titles": ["How to make money online fast", "How to make money online easily"]}
        )
    ...
    def test_confidence_increases_with_data(self):
        ...
        rich = score_content(
            {
                "title": "Why this secret?",
                "hook_text": "Why?",
                "body_text": "long body " * 20,
                "cta_type": "direct",
                "offer_id": "abc",
                "platform": "tiktok",
                "content_type": "short_video",
    ...
    def test_warn_verdict_range(self):
        content = {
            "title": "Test?",
            "body_text": "Some text here for the body",
            "platform": "tiktok",
            "content_type": "short_video",
        }
        result = score_content(content, {})
