...
class TestRecovery:
    ...
    def test_operator_review(self):
        incident = {
            "incident_type": "unsafe_system_state",
            "severity": "critical",
    ...
    def test_rollback_action(self):
        incident = {
            "incident_type": "publish_failure",
            "severity": "high",
            "affected_scope": "content_item",
            "detail": "Failed",
            "auto_recoverable": True,
        }
        recovery = decide_recovery(incident)
    ...
    def test_throttle_action(self):
        incident = {
            "incident_type": "bad_scaling_push",
            "severity": "high",
...
class TestEscalation:
    def test_critical_non_auto_escalates(self):
        assert (
            should_escalate({"severity": "critical", "auto_recoverable": False}, {"decision": "operator_review"})
            is True
        )
