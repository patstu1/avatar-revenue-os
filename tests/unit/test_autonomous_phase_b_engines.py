...
class TestComputePoliciesForBrand:
    ...
    def test_all_policies_have_mode(self):
        results = compute_policies_for_brand(
            ["publish_content", "suppress_lane"],
            {"publish_content": 0.9, "suppress_lane": 0.3},
            0.5,
            {},
        )
        for r in results:
...
class TestSelectMonetizationRoute:
        ...
        result = select_monetization_route(
            {
                ...
                "monetization_path_hint": "affiliate",
                "urgency": 0.7,
            },
            [
                {
    ...
    def test_route_class_is_valid(self):
        result = select_monetization_route(
            ...
            {"conversion_intent": 0.8},
            {"platform": "youtube", "maturity_state": "stable", "health_score": 0.8},
        )
...
class TestEvaluateSuppressions:
    ...
    def test_weak_content_family_suppressed(self):
        results = evaluate_suppressions(
            ...
            [
                {
                    "id": "q1",
                    "content_family": "creative_refresh",
                    "platform": "youtube",
                    "priority_score": 0.1,
    ...
    def test_all_suppression_types_valid(self):
        results = evaluate_suppressions(
            ...
            {"content_fatigue_score": 0.9, "revenue_trend": "down", "overall_engagement_rate": 0.01},
        )
        for s in results:
    ...
    def test_suppression_has_required_fields(self):
        ...
        for s in results:
            for key in ["suppression_type", "affected_scope", "trigger_reason", "confidence", "explanation"]:
                assert key in s
        ...
        result = plan_distribution(
            ...
            available_accounts=[
                ...
                },
                {
                    ...
                    "maturity_state": "stable",
                    "health_score": 0.6,
                    "current_output_per_week": 3,
                    "max_safe_output_per_week": 7,
                },
            ],
            platform_policies=[
