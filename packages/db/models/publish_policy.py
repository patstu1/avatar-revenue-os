...
class PublishPolicyRule(Base):
    ...
    match_tags_contain: Mapped[Optional[list]] = mapped_column(
        JSONB,
        nullable=True,
    ...
    max_account_age_days: Mapped[Optional[int]] = mapped_column(
        Integer,
        nullable=True,
    ...
    min_confidence: Mapped[Optional[str]] = mapped_column(
        String(20),
        nullable=True,
