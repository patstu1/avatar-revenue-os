...
class InboxConnection(Base):
    ...
    __table_args__ = (UniqueConstraint("org_id", "email_address", name="uq_inbox_org_email"),)
...
class EmailThread(Base):
    ...
    __table_args__ = (UniqueConstraint("inbox_connection_id", "provider_thread_id", name="uq_thread_inbox_provider"),)
    ...
    )  # e.g. Message-ID or References chain hash
    ...
    )  # pending, drafted, sent, escalated, closed
...
class EmailMessage(Base):
    ...
    __table_args__ = (UniqueConstraint("provider_message_id", name="uq_email_message_provider_id"),)
...
class SalesStageTransition(Base):
    ...
    )  # email_inbound, email_outbound, manual, payment, website
