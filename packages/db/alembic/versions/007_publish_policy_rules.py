...
def upgrade() -> None:
    ...
    if not _column_exists("approvals", "sample_flagged"):
        op.add_column(
            "approvals", sa.Column("sample_flagged", sa.Boolean, default=False, server_default=sa.text("false"))
        )
    ...
    op.bulk_insert(
        ...
        [
            # ── BLOCK tier (highest priority — catch dangerous content first) ──
            {
                ...
                "match_platform": None,
                "match_monetization_method": None,
                "match_has_offer": None,
                "match_tags_contain": None,
                "match_account_health": None,
            ...
            {
                "name": "block_insufficient_confidence",
                "priority": 20,
                "tier": "block",
                "sample_rate": 0.0,
                "min_confidence": "low",
            ...
            {
                "name": "manual_sponsored",
                "priority": 60,
                "tier": "manual_approval",
                "sample_rate": 0.0,
                "match_monetization_method": "sponsor",
                "is_active": True,
            ...
            {
                "name": "manual_degraded_accounts",
                "priority": 80,
                "tier": "manual_approval",
                "sample_rate": 0.0,
                "match_account_health": "degraded",
                "is_active": True,
            ...
            {
                "name": "sample_affiliate",
                "priority": 90,
                "tier": "sample_review",
                "sample_rate": 0.15,
                "match_has_offer": True,
                "match_monetization_method": "affiliate",
                "is_active": True,
            ...
            {
                "name": "sample_live_stream",
                "priority": 100,
                "tier": "sample_review",
                "sample_rate": 0.25,
                "match_content_type": "live_stream",
                "is_active": True,
            ...
            {
                "name": "sample_carousel",
                "priority": 110,
                "tier": "sample_review",
                "sample_rate": 0.10,
                "match_content_type": "carousel",
                "is_active": True,
            ...
            {
                "name": "sample_strict_governance",
                "priority": 120,
                "tier": "sample_review",
                "sample_rate": 0.20,
                "match_governance_level": "strict",
                "is_active": True,
