...
def upgrade() -> None:
    op.create_table(
        ...
        *_b(),
        ...
        sa.Column("content_published", sa.Integer(), server_default="0"),
        sa.Column("total_impressions", sa.Float(), server_default="0"),
        sa.Column("avg_engagement_rate", sa.Float(), server_default="0"),
        sa.Column("avg_conversion_rate", sa.Float(), server_default="0"),
        sa.Column("active_accounts", sa.Integer(), server_default="0"),
        sa.Column("active_campaigns", sa.Integer(), server_default="0"),
        sa.Column("kpi_json", JSONB(), server_default="{}"),
    ...
    op.create_table(
        ...
        *_b(),
        ...
        sa.Column("forecast_period", sa.String(30), nullable=False),
        sa.Column("predicted_value", sa.Float(), server_default="0"),
        sa.Column("confidence", sa.Float(), server_default="0"),
        sa.Column("risk_factors", JSONB(), server_default="[]"),
        sa.Column("opportunity_factors", JSONB(), server_default="[]"),
    ...
    op.create_table(
        ...
        *_b(),
        ...
        sa.Column("period", sa.String(30), nullable=False),
        sa.Column("uptime_pct", sa.Float(), server_default="100"),
        ...
        sa.Column("reliability_grade", sa.String(5), server_default="A"),
        sa.Column("is_active", sa.Boolean(), server_default=sa.text("true")),
        sa.ForeignKeyConstraint(["organization_id"], ["organizations.id"]),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        *_b(),
        sa.Column("organization_id", sa.UUID(), nullable=False),
        sa.Column("mode", sa.String(30), server_default="hybrid"),
        sa.Column("auto_approved_count", sa.Integer(), server_default="0"),
        sa.Column("human_reviewed_count", sa.Integer(), server_default="0"),
        sa.Column("override_count", sa.Integer(), server_default="0"),
        sa.Column("ai_accuracy_estimate", sa.Float(), server_default="0"),
    ...
    op.create_table(
        ...
        *_b(),
        ...
        sa.Column("active_issues", sa.Integer(), server_default="0"),
        sa.Column("last_incident", sa.Text()),
        sa.Column("is_active", sa.Boolean(), server_default=sa.text("true")),
        sa.ForeignKeyConstraint(["organization_id"], ["organizations.id"]),
        sa.PrimaryKeyConstraint("id"),
    )
