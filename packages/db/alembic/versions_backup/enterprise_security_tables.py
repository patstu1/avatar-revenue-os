...
def upgrade() -> None:
    op.create_table(
        ...
        *_base(),
        ...
        sa.Column("role_level", sa.Integer(), server_default="50"),
    ...
    op.create_table(
        ...
        *_base(),
        ...
        sa.Column("is_active", sa.Boolean(), server_default=sa.text("true")),
        sa.ForeignKeyConstraint(["role_id"], ["es_roles.id"]),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        *_base(),
        sa.Column("organization_id", sa.UUID(), nullable=False),
        sa.Column("group_name", sa.String(120), nullable=False),
    ...
    op.create_table(
        ...
        *_base(),
        ...
        sa.Column("before_state", JSONB(), server_default="{}"),
        sa.Column("after_state", JSONB(), server_default="{}"),
    ...
    op.create_table(
        ...
        *_base(),
        ...
        sa.Column("restricted_fields", JSONB(), server_default="[]"),
        sa.Column("masking_rules", JSONB(), server_default="{}"),
        sa.Column("model_restriction", sa.String(60)),
        sa.Column("private_mode", sa.Boolean(), server_default=sa.text("false")),
        sa.Column("training_leak_prevention", sa.Boolean(), server_default=sa.text("true")),
        sa.Column("is_active", sa.Boolean(), server_default=sa.text("true")),
        sa.ForeignKeyConstraint(["organization_id"], ["organizations.id"]),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        *_base(),
        ...
        sa.Column("isolation_mode", sa.String(30), server_default="shared"),
        sa.Column("dedicated_instance_id", sa.String(255)),
        sa.Column("data_residency", sa.String(40)),
    ...
    op.create_table(
        ...
        *_base(),
        ...
        sa.Column("status", sa.String(30), server_default="not_assessed"),
