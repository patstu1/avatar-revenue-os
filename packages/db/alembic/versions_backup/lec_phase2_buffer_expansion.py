...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", sa.String(30), server_default=sa.text("'completed'"), nullable=False, index=True),
        sa.Column(
            "credential_status", sa.String(30), server_default=sa.text("'not_configured'"), nullable=False, index=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "reconciliation_status", sa.String(30), server_default=sa.text("'clean'"), nullable=False, index=True
        ),
        sa.Column(
            "credential_status", sa.String(30), server_default=sa.text("'not_configured'"), nullable=False, index=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "report_type", sa.String(80), server_default=sa.text("'campaign_summary'"), nullable=False, index=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "truth_state", sa.String(40), server_default=sa.text("'queued_internally'"), nullable=False, index=True
        ),
