...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        *_b(),
        ...
        sa.Column("partner_email", sa.String(255)),
        sa.Column("partner_status", sa.String(20), server_default="pending"),
        sa.Column("partner_score", sa.Float(), server_default="0"),
        sa.Column("conversion_quality", sa.Float(), server_default="0"),
        sa.Column("fraud_risk", sa.Float(), server_default="0"),
        sa.Column("total_conversions", sa.Integer(), server_default="0"),
        sa.Column("total_revenue_generated", sa.Float(), server_default="0"),
        sa.Column("total_payout", sa.Float(), server_default="0"),
        sa.Column("asset_kit_assigned", sa.Boolean(), server_default=sa.text("false")),
        sa.Column("is_active", sa.Boolean(), server_default=sa.text("true")),
        sa.ForeignKeyConstraint(["organization_id"], ["organizations.id"]),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        *_b(),
        ...
        sa.Column("fraud_flag", sa.Boolean(), server_default=sa.text("false")),
        sa.Column("is_active", sa.Boolean(), server_default=sa.text("true")),
        sa.ForeignKeyConstraint(["partner_id"], ["af_own_partners.id"]),
        sa.PrimaryKeyConstraint("id"),
    )
