    ...
    for tbl, cols in [
        (
            ...
            [
                ...
                sa.Column("brand_summary", sa.Text()),
                sa.Column("tone_profile", sa.Text()),
        ...
        (
            ...
            [
                ...
                sa.Column("rule_value", JSONB(), server_default="{}"),
        ...
        (
            ...
            [
                sa.Column("brand_id", sa.UUID(), nullable=False),
                sa.Column("kb_type", sa.String(60), nullable=False),
        ...
        (
            ...
            [
                ...
                sa.Column("is_active", sa.Boolean(), server_default=sa.text("true")),
                sa.ForeignKeyConstraint(["knowledge_base_id"], ["bg_knowledge_bases.id"]),
            ],
        ),
        (
            ...
            [
                ...
                sa.Column("trust_level", sa.String(20), server_default="medium"),
                sa.Column("objection_patterns", JSONB(), server_default="[]"),
                sa.Column("preferred_content_forms", JSONB(), server_default="[]"),
                sa.Column("monetization_sensitivity", sa.String(20), server_default="medium"),
                sa.Column("channel_preferences", JSONB(), server_default="[]"),
                sa.Column("language", sa.String(10), server_default="en"),
                sa.Column("is_active", sa.Boolean(), server_default=sa.text("true")),
                sa.ForeignKeyConstraint(["brand_id"], ["brands.id"]),
            ],
        ...
        (
            ...
            [
                ...
                sa.Column("check_value", JSONB(), server_default="{}"),
                sa.Column("severity", sa.String(20), server_default="hard"),
                sa.Column("is_active", sa.Boolean(), server_default=sa.text("true")),
                sa.ForeignKeyConstraint(["brand_id"], ["brands.id"]),
            ],
        ...
        (
            ...
            [
                ...
                sa.Column("asset_url", sa.String(1000)),
                sa.Column("metadata_json", JSONB(), server_default="{}"),
                sa.Column("is_active", sa.Boolean(), server_default=sa.text("true")),
                sa.ForeignKeyConstraint(["brand_id"], ["brands.id"]),
            ],
        ...
        (
            ...
            [
                sa.Column("brand_id", sa.UUID(), nullable=False),
                sa.Column("token_key", sa.String(80), nullable=False),
                sa.Column("token_value", sa.String(500), nullable=False),
                sa.Column("token_category", sa.String(40), server_default="general"),
                sa.Column("is_active", sa.Boolean(), server_default=sa.text("true")),
                sa.ForeignKeyConstraint(["brand_id"], ["brands.id"]),
            ],
        ),
        (
            ...
            [
                ...
                sa.Column("violation_type", sa.String(60), nullable=False),
