...
def upgrade() -> None:
    op.create_table(
        ...
        *_b(),
        ...
        sa.Column("auth_method", sa.String(30), server_default="api_key"),
        sa.Column("credential_env_key", sa.String(120)),
        sa.Column("sync_direction", sa.String(20), server_default="inbound"),
    ...
    op.create_table(
        ...
        *_b(),
        ...
        sa.Column("is_active", sa.Boolean(), server_default=sa.text("true")),
        sa.ForeignKeyConstraint(["connector_id"], ["il_connectors.id"]),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        *_b(),
        ...
        sa.Column("data_json", JSONB(), server_default="{}"),
    ...
    op.create_table(
        ...
        *_b(),
        sa.Column("organization_id", sa.UUID(), nullable=False),
        sa.Column("brand_id", sa.UUID()),
        sa.Column("cluster_type", sa.String(40), nullable=False),
        ...
        sa.Column("avg_relevance", sa.Float(), server_default="0"),
        sa.Column("representative_texts", JSONB(), server_default="[]"),
    ...
    op.create_table(
        ...
        *_b(),
        ...
        sa.Column("is_active", sa.Boolean(), server_default=sa.text("true")),
        sa.ForeignKeyConstraint(["organization_id"], ["organizations.id"]),
        sa.ForeignKeyConstraint(["cluster_id"], ["il_listening_clusters.id"]),
        sa.PrimaryKeyConstraint("id"),
    )
