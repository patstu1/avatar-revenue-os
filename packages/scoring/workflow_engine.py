    ...
    "campaign_launch": {
        ...
        "steps": [
            ...
            },
            {
                ...
                "step_type": "compliance_review",
                "required_role": "approver",
                "required_action": "approve",
            },
            {
                "step_order": 3,
                "step_name": "Launch Approval",
                "step_type": "publish_approval",
...
def evaluate_workflow_step(instance: dict[str, Any], steps: list[dict[str, Any]], user_role: str) -> dict[str, Any]:
    ...
    if required_role and user_role != required_role and user_role not in ("super_admin", "org_admin"):
        return {
            "can_act": False,
            "reason": f"Step requires role '{required_role}', user has '{user_role}'",
            "step": current_step,
        }
...
def get_pending_actions(
    instances: list[dict[str, Any]], steps_map: dict[str, list[dict]], user_role: str
) -> list[dict[str, Any]]:
            ...
            pending.append(
                {
                    ...
                    "step_name": eval_result["step"]["step_name"],
