...
PLATFORM_REGISTRY: list[dict[str, Any]] = [
    # ── P0: Core Platforms (Buffer-automated) ────────────────────────
    {
        ...
        "constraints": {
            ...
            "max_hashtags": 30,
            "video_max_sec": 90,
            "image_sizes": {"feed": [1080, 1080], "story": [1080, 1920], "reel": [1080, 1920]},
        },
        "buffer_supported": True,
        "publish_mode": "buffer",
        "execution_truth": "live_when_configured",
        "analytics_source": "instagram_insights",
        "expansion_suitability": 0.85,
        "credential_env": "BUFFER_API_KEY",
        "blocker_state": None,
    },
    {
        "platform_key": "tiktok",
        ...
        "constraints": {
            ...
            "max_hashtags": 5,
            "video_max_sec": 180,
            "image_sizes": {"video": [1080, 1920]},
        },
        "buffer_supported": True,
        "publish_mode": "buffer",
        "execution_truth": "live_when_configured",
        "analytics_source": "tiktok_analytics",
        "expansion_suitability": 0.90,
        "credential_env": "BUFFER_API_KEY",
        "blocker_state": None,
    },
    {
        ...
        "constraints": {
            ...
            "max_hashtags": 15,
            "video_max_sec": 60,
            "image_sizes": {"thumbnail": [1280, 720], "short": [1080, 1920]},
        },
        "buffer_supported": True,
        "publish_mode": "buffer",
        "execution_truth": "live_when_configured",
        "analytics_source": "youtube_analytics",
        "expansion_suitability": 0.80,
        "credential_env": "BUFFER_API_KEY",
        "blocker_state": None,
    },
    {
        ...
        "constraints": {
            ...
            "max_hashtags": 3,
            "video_max_sec": 140,
            "image_sizes": {"post": [1200, 675]},
        },
        "buffer_supported": True,
        "publish_mode": "buffer",
        "execution_truth": "live_when_configured",
        "analytics_source": "x_analytics",
        "expansion_suitability": 0.70,
        "credential_env": "BUFFER_API_KEY",
        "blocker_state": None,
    },
    {
        "platform_key": "blog",
        "display_name": "Blog / Website",
        "priority": 0,
        ...
        "constraints": {
            ...
            "max_hashtags": 10,
            "video_max_sec": None,
            "image_sizes": {"hero": [1200, 630], "inline": [800, 450]},
        },
        "buffer_supported": False,
        "publish_mode": "manual",
        "execution_truth": "recommendation_only",
        "analytics_source": "google_analytics",
        "expansion_suitability": 0.75,
        "credential_env": None,
        "blocker_state": "no_cms_client",
    },
    # ── P1: Expansion Platforms ──────────────────────────────────────
    {
        ...
        "publish_mode": "buffer",
        "execution_truth": "live_when_configured",
        "analytics_source": "meta_insights",
        "expansion_suitability": 0.65,
        "credential_env": "BUFFER_API_KEY",
        "blocker_state": None,
    },
    {
        ...
        "constraints": {
            ...
            "max_hashtags": 20,
            "video_max_sec": 60,
            "image_sizes": {"pin": [1000, 1500]},
        },
        "buffer_supported": True,
        "publish_mode": "buffer",
        "execution_truth": "live_when_configured",
        "analytics_source": "pinterest_analytics",
        "expansion_suitability": 0.70,
        "credential_env": "BUFFER_API_KEY",
        "blocker_state": None,
    },
    {
        ...
        "constraints": {
            ...
            "max_hashtags": 0,
            "video_max_sec": 900,
            "image_sizes": {"post": [1200, 628]},
        },
        "buffer_supported": False,
        "publish_mode": "manual",
        "execution_truth": "recommendation_only",
        "analytics_source": "reddit_api",
        "expansion_suitability": 0.55,
        "credential_env": None,
        "blocker_state": "no_direct_publish_client",
    },
    {
        ...
        "publish_mode": "buffer",
        "execution_truth": "live_when_configured",
        "analytics_source": "linkedin_analytics",
        "expansion_suitability": 0.75,
        "credential_env": "BUFFER_API_KEY",
        "blocker_state": None,
    },
    # ── P2: Extended Platforms ───────────────────────────────────────
    {
        ...
        "constraints": {
            ...
            "max_hashtags": 0,
            "video_max_sec": 300,
            "image_sizes": {"post": [1080, 1080]},
        },
        "buffer_supported": True,
        "publish_mode": "buffer",
        "execution_truth": "live_when_configured",
        "analytics_source": "threads_insights",
        "expansion_suitability": 0.45,
        "credential_env": "BUFFER_API_KEY",
        "blocker_state": None,
    },
    {
        ...
        "constraints": {
            ...
            "max_hashtags": 0,
            "video_max_sec": 60,
            "image_sizes": {"snap": [1080, 1920]},
        },
        "buffer_supported": False,
        "publish_mode": "manual",
        "execution_truth": "recommendation_only",
        "analytics_source": "snapchat_insights",
        "expansion_suitability": 0.35,
        "credential_env": None,
        "blocker_state": "no_direct_publish_client",
    },
    {
        "platform_key": "email_newsletter",
        ...
        "constraints": {
            ...
            "max_hashtags": 0,
            "video_max_sec": None,
            "image_sizes": {"header": [600, 200], "inline": [600, 400]},
        },
        "buffer_supported": False,
        "publish_mode": "esp_service",
        "execution_truth": "live_when_configured",
        "analytics_source": "esp_analytics",
        "expansion_suitability": 0.90,
        "credential_env": "SMTP_HOST",
        "blocker_state": "blocked_without_esp",
    },
    {
        "platform_key": "seo_authority",
        "display_name": "SEO Authority Pages",
        "priority": 2,
        ...
        "constraints": {
            ...
            "max_hashtags": 0,
            "video_max_sec": None,
            "image_sizes": {"hero": [1200, 630]},
        },
        "buffer_supported": False,
        "publish_mode": "manual",
        "execution_truth": "recommendation_only",
        "analytics_source": "google_search_console",
        "expansion_suitability": 0.80,
        "credential_env": None,
        "blocker_state": "no_cms_client",
    },
    # ── P3: Optional / Community Platforms ───────────────────────────
    {
        ...
        "constraints": {
            ...
            "max_hashtags": 0,
            "video_max_sec": None,
            "image_sizes": {"post": [1280, 720]},
        },
        "buffer_supported": False,
        "publish_mode": "manual",
        "execution_truth": "recommendation_only",
        "analytics_source": "telegram_bot_api",
        "expansion_suitability": 0.50,
        "credential_env": None,
        "blocker_state": "no_direct_publish_client",
    },
    {
        ...
        "constraints": {
            ...
            "max_hashtags": 0,
            "video_max_sec": None,
            "image_sizes": {"embed": [1280, 720]},
        },
        "buffer_supported": False,
        "publish_mode": "manual",
        "execution_truth": "recommendation_only",
        "analytics_source": "discord_bot_api",
        "expansion_suitability": 0.45,
        "credential_env": None,
        "blocker_state": "no_direct_publish_client",
    },
    {
        ...
        "constraints": {
            ...
            "max_hashtags": 5,
            "video_max_sec": None,
            "image_sizes": {"hero": [1400, 788]},
        },
        "buffer_supported": False,
        "publish_mode": "manual",
        "execution_truth": "recommendation_only",
        "analytics_source": "medium_stats",
        "expansion_suitability": 0.55,
        "credential_env": None,
        "blocker_state": "no_direct_publish_client",
    },
    {
        ...
        "constraints": {
            ...
            "max_hashtags": 0,
            "video_max_sec": None,
            "image_sizes": {"hero": [1456, 816]},
        },
        "buffer_supported": False,
        "publish_mode": "manual",
        "execution_truth": "recommendation_only",
        "analytics_source": "substack_dashboard",
        "expansion_suitability": 0.70,
        "credential_env": None,
        "blocker_state": "no_direct_publish_client",
    },
...
def get_platform_readiness(platform_key: str) -> dict[str, Any]:
    ...
    if not p:
        return {
            ...
            "ready": False,
            "execution_truth": "unknown_platform",
            "blocker": "Platform not in registry",
        }
...
def detect_platform_blockers(platform_key: str) -> list[dict[str, str]]:
    ...
    if r["blocker"]:
        blockers.append(
            {
                "type": r["blocker"],
                "description": f"{r['display_name']}: {r['blocker']} (publish_mode={r['publish_mode']}, truth={r['execution_truth']})",
            }
        )
    return blockers
