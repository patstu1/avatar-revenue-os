...
class WFDefinitionOut(BaseModel):
    ...
    id: uuid.UUID; workflow_name: str; workflow_type: str; scope_type: str; is_active: bool

class WFInstanceOut(BaseModel):
    model_config = ConfigDict(from_attributes=True)
    id: uuid.UUID; resource_type: str; current_step_order: int; status: str
