...
class PricingRecommendation(Base):
    ...
    __table_args__ = (
        UniqueConstraint("brand_id", "offer_id", name="uq_pricing_brand_offer"),
    )
...
class BundleRecommendation(Base):
    ...
    __table_args__ = (
        UniqueConstraint("brand_id", "bundle_name", name="uq_bundle_brand_name"),
    )
...
class RetentionRecommendation(Base):
    ...
    __table_args__ = (
        UniqueConstraint("brand_id", "customer_segment", name="uq_retention_brand_segment"),
    )
...
class ReactivationCampaign(Base):
    ...
    __table_args__ = (
        UniqueConstraint("brand_id", "campaign_name", name="uq_reactivation_brand_campaign"),
    )
