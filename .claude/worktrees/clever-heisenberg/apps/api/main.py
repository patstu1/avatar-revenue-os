...
app.include_router(microsoft_inbox_oauth.router, prefix="/api/v1", tags=["Microsoft Inbox OAuth"])
app.include_router(landing_pages.public_router, prefix="/api/v1", tags=["Public Landing Pages: Dynamic page rendering"])
