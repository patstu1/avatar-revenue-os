...
class HSScaleHealthOut(BaseModel):
    model_config = ConfigDict(from_attributes=True)
    id: uuid.UUID; health_status: str; queue_depth_total: int; ceiling_utilization_pct: float; burst_count_24h: int; degradation_count_24h: int; recommendation: Optional[str] = None
