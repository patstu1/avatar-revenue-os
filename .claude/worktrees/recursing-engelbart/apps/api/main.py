...
app.include_router(revenue_assignment.router, prefix="/api/v1/revenue-assignments", tags=["Revenue Assignments"])
app.include_router(youtube_dashboard.router, prefix="/api/v1/youtube", tags=["YouTube Integration"])
app.include_router(personas.router, prefix="/api/v1/personas", tags=["AI Personas"])
app.include_router(newsletter.router, prefix="/api/v1/newsletter", tags=["Newsletter Integration"])
