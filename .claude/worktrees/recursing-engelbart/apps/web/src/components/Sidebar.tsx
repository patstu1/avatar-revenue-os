...
const NAV_SECTIONS: NavSection[] = [
...

  {
    ...
    items: [
      ...
      { href: "/dashboard/youtube", label: "YouTube", icon: Video },
      { href: "/dashboard/newsletter", label: "Newsletter", icon: Mail },
      { href: "/dashboard/personas", label: "AI Personas", icon: Sparkles },
      { href: "/dashboard/ops", label: "Operator Command", icon: Shield },
      { href: "/dashboard/revenue-assignments", label: "Revenue Assignments", icon: Layers },
