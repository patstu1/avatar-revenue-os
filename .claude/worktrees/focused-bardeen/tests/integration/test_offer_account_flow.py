...
async def _setup(api_client, sample_org_data) -> tuple[dict, str]:
    ...
    brand = await api_client.post("/api/v1/brands/", json={
        "name": "OA Test Brand", "slug": "oa-test",
    }, headers=headers)
...
async def test_create_offer(api_client, sample_org_data):
    ...
    response = await api_client.post("/api/v1/offers/", json={
        "brand_id": brand_id, "name": "Test Affiliate",
        "monetization_method": "affiliate", "payout_amount": 25.0,
        "epc": 1.50, "conversion_rate": 0.03,
    }, headers=headers)
...
async def test_list_offers(api_client, sample_org_data):
    ...
    await api_client.post("/api/v1/offers/", json={
        "brand_id": brand_id, "name": "Offer 1", "monetization_method": "affiliate",
    }, headers=headers)
    await api_client.post("/api/v1/offers/", json={
        "brand_id": brand_id, "name": "Offer 2", "monetization_method": "product",
    }, headers=headers)
...
async def test_delete_offer(api_client, sample_org_data):
    headers, brand_id = await _setup(api_client, sample_org_data)
    create = await api_client.post("/api/v1/offers/", json={
        "brand_id": brand_id, "name": "To Delete", "monetization_method": "affiliate",
    }, headers=headers)
...
async def test_create_creator_account(api_client, sample_org_data):
    ...
    response = await api_client.post("/api/v1/accounts/", json={
        ...
        "platform_username": "@testchannel", "niche_focus": "finance",
...
async def test_list_creator_accounts(api_client, sample_org_data):
    ...
    await api_client.post("/api/v1/accounts/", json={
        "brand_id": brand_id, "platform": "youtube", "platform_username": "@ch1",
    }, headers=headers)
    await api_client.post("/api/v1/accounts/", json={
        "brand_id": brand_id, "platform": "tiktok", "platform_username": "@ch2",
    }, headers=headers)
...
async def test_delete_creator_account(api_client, sample_org_data):
    headers, brand_id = await _setup(api_client, sample_org_data)
    create = await api_client.post("/api/v1/accounts/", json={
        "brand_id": brand_id, "platform": "instagram", "platform_username": "@del",
    }, headers=headers)
...
async def test_offer_creation_creates_audit_log(api_client, sample_org_data):
    headers, brand_id = await _setup(api_client, sample_org_data)
    await api_client.post("/api/v1/offers/", json={
        "brand_id": brand_id, "name": "Audit Offer", "monetization_method": "affiliate",
    }, headers=headers)
...
async def test_account_creation_creates_audit_log(api_client, sample_org_data):
    headers, brand_id = await _setup(api_client, sample_org_data)
    await api_client.post("/api/v1/accounts/", json={
        "brand_id": brand_id, "platform": "youtube", "platform_username": "@auditchan",
    }, headers=headers)
