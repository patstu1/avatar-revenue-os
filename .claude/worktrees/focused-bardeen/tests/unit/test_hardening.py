...
class TestGlobalExceptionHandler:
    ...
    def test_app_imports_and_registers_handlers(self):
        ...
        import importlib
        import os
        # Use importlib.util to find the source file without triggering full module init
...
class TestTrackedTask:
    ...
    def test_tracked_task_retry_config(self):
        from workers.base_task import TrackedTask
        # TrackedTask uses retry_backoff with unlimited retries (max_retries=None in on_failure)
        assert TrackedTask.retry_backoff is True
        assert TrackedTask.retry_jitter is True
