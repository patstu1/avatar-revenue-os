...
PROVIDER_INVENTORY: list[dict[str, Any]] = [
    ...
    {
        "provider_key": "claude", "display_name": "Claude (Anthropic)", "category": "ai_text",
        "provider_type": "primary", "is_primary": True, "is_fallback": False, "is_optional": False,
        "env_keys": ["ANTHROPIC_API_KEY"], "integration_status": "live",
    ...
    {
        "provider_key": "gemini_flash", "display_name": "Gemini 2.5 Flash", "category": "ai_text",
        "provider_type": "primary", "is_primary": True, "is_fallback": False, "is_optional": False,
        "env_keys": ["GOOGLE_AI_API_KEY"], "integration_status": "live",
    ...
    {
        "provider_key": "deepseek", "display_name": "DeepSeek V3.2", "category": "ai_text",
        "provider_type": "primary", "is_primary": False, "is_fallback": False, "is_optional": False,
        "env_keys": ["DEEPSEEK_API_KEY"], "integration_status": "live",
    ...
    {
        "provider_key": "openai", "display_name": "OpenAI", "category": "ai_reasoning",
        "provider_type": "fallback", "is_primary": False, "is_fallback": True, "is_optional": False,
        "env_keys": ["OPENAI_API_KEY"], "integration_status": "live",
    ...
    {
        "provider_key": "gpt_image", "display_name": "GPT Image 1.5 (OpenAI)", "category": "ai_image",
        "provider_type": "primary", "is_primary": True, "is_fallback": False, "is_optional": False,
        "env_keys": ["OPENAI_API_KEY"], "integration_status": "live",
    ...
    {
        "provider_key": "imagen4", "display_name": "Google Imagen 4 Fast", "category": "ai_image",
        "provider_type": "primary", "is_primary": True, "is_fallback": False, "is_optional": False,
        "env_keys": ["GOOGLE_AI_API_KEY"], "integration_status": "live",
    ...
    {
        "provider_key": "flux", "display_name": "Flux 2 Pro (fal.ai)", "category": "ai_image",
        "provider_type": "optional", "is_primary": False, "is_fallback": False, "is_optional": True,
        "env_keys": ["FAL_API_KEY"], "integration_status": "live",
    ...
    {
        "provider_key": "runway", "display_name": "Runway Gen-4 Turbo", "category": "ai_video",
        "provider_type": "primary", "is_primary": True, "is_fallback": False, "is_optional": False,
        "env_keys": ["RUNWAY_API_KEY"], "integration_status": "live",
    ...
    {
        "provider_key": "kling", "display_name": "Kling AI (fal.ai)", "category": "ai_video",
        "provider_type": "primary", "is_primary": True, "is_fallback": False, "is_optional": False,
        "env_keys": ["FAL_API_KEY"], "integration_status": "live",
    ...
    {
        "provider_key": "heygen", "display_name": "HeyGen", "category": "ai_avatar",
        "provider_type": "primary", "is_primary": True, "is_fallback": False, "is_optional": False,
        "env_keys": ["HEYGEN_API_KEY"], "integration_status": "live",
    ...
    {
        "provider_key": "did", "display_name": "D-ID", "category": "ai_avatar",
        "provider_type": "fallback", "is_primary": False, "is_fallback": True, "is_optional": False,
        "env_keys": ["DID_API_KEY"], "integration_status": "live",
    ...
    {
        "provider_key": "tavus", "display_name": "Tavus", "category": "ai_avatar",
        "provider_type": "optional", "is_primary": False, "is_fallback": False, "is_optional": True,
        "env_keys": ["TAVUS_API_KEY"], "integration_status": "partial",
    ...
    {
        "provider_key": "elevenlabs", "display_name": "ElevenLabs", "category": "ai_voice",
        "provider_type": "primary", "is_primary": True, "is_fallback": False, "is_optional": False,
        "env_keys": ["ELEVENLABS_API_KEY"], "integration_status": "live",
    ...
    {
        "provider_key": "fish_audio", "display_name": "Fish Audio", "category": "ai_voice",
        "provider_type": "primary", "is_primary": True, "is_fallback": False, "is_optional": False,
        "env_keys": ["FISH_AUDIO_API_KEY"], "integration_status": "live",
    ...
    {
        "provider_key": "voxtral", "display_name": "Voxtral TTS (Mistral)", "category": "ai_voice",
        "provider_type": "optional", "is_primary": False, "is_fallback": False, "is_optional": True,
        "env_keys": ["MISTRAL_API_KEY"], "integration_status": "live",
    ...
    # ── AI Music ──
    {
        "provider_key": "suno", "display_name": "Suno", "category": "ai_music",
        "provider_type": "primary", "is_primary": True, "is_fallback": False, "is_optional": False,
        "env_keys": ["SUNO_API_KEY"], "integration_status": "live",
        "description": "Background music, intros, branded jingles. ~$10-30/mo subscription.",
        "capabilities": ["music_generation", "background_tracks"],
    },
    # ── Fallback ──
    {
        "provider_key": "fallback_media", "display_name": "Fallback (Template)", "category": "ai_media",
        "provider_type": "fallback", "is_primary": False, "is_fallback": True, "is_optional": False,
        "env_keys": [], "integration_status": "live",
...
PROVIDER_DEPENDENCIES: list[dict[str, Any]] = [
    {"provider_key": "claude", "module_path": "system.reasoning", "dependency_type": "primary", "description": "Primary reasoning model for planning, decisions, copilot intelligence"},
    {"provider_key": "openai", "module_path": "packages.provider_clients.media_providers.OpenAIRealtimeAdapter", "dependency_type": "optional", "description": "Realtime voice/media only"},
    {"provider_key": "tavus", "module_path": "packages.provider_clients.media_providers.TavusAdapter", "dependency_type": "primary", "description": "Avatar video generation pipeline"},
    {"provider_key": "elevenlabs", "module_path": "packages.provider_clients.media_providers.ElevenLabsAdapter", "dependency_type": "primary", "description": "Voice synthesis pipeline"},
    {"provider_key": "heygen", "module_path": "packages.provider_clients.media_providers.HeyGenLiveAvatarAdapter", "dependency_type": "optional", "description": "Live avatar streaming"},
    {"provider_key": "stripe", "module_path": "packages.clients.external_clients.StripePaymentClient", "dependency_type": "primary", "description": "Payment connector sync + webhook verification"},
    {"provider_key": "stripe", "module_path": "apps.api.routers.webhooks.stripe_webhook", "dependency_type": "primary", "description": "Stripe webhook endpoint"},
    {"provider_key": "shopify", "module_path": "packages.clients.external_clients.ShopifyOrderClient", "dependency_type": "optional", "description": "Shopify batch order sync"},
    {"provider_key": "shopify", "module_path": "apps.api.routers.webhooks.shopify_webhook", "dependency_type": "optional", "description": "Shopify webhook endpoint"},
    {"provider_key": "buffer", "module_path": "packages.clients.external_clients.BufferClient", "dependency_type": "primary", "description": "Buffer social distribution"},
    {"provider_key": "buffer", "module_path": "apps.api.services.buffer_distribution_service", "dependency_type": "primary", "description": "Buffer publish/sync/blockers"},
    {"provider_key": "meta_ads", "module_path": "packages.clients.external_clients.MetaAdsClient", "dependency_type": "optional", "description": "Meta ad reporting import"},
    {"provider_key": "google_ads", "module_path": "packages.clients.external_clients.GoogleAdsClient", "dependency_type": "optional", "description": "Google ad reporting import"},
    {"provider_key": "tiktok_ads", "module_path": "packages.clients.external_clients.TikTokAdsClient", "dependency_type": "optional", "description": "TikTok ad reporting import"},
    {"provider_key": "crm", "module_path": "apps.api.services.live_execution_service.run_crm_sync", "dependency_type": "optional", "description": "CRM contact sync"},
    {"provider_key": "smtp", "module_path": "packages.clients.external_clients.SmtpEmailClient", "dependency_type": "primary", "description": "Email send execution"},
    {"provider_key": "esp", "module_path": "apps.api.services.live_execution_service.execute_pending_emails", "dependency_type": "optional", "description": "ESP-based email delivery"},
    {"provider_key": "twilio", "module_path": "packages.clients.external_clients.TwilioSmsClient", "dependency_type": "primary", "description": "SMS send execution"},
    {"provider_key": "slack", "module_path": "packages.notifications.adapters.SlackWebhookAdapter", "dependency_type": "optional", "description": "Operator alert delivery via Slack"},
    {"provider_key": "s3", "module_path": "workers.generation_worker", "dependency_type": "optional", "description": "Media asset storage"},
    {"provider_key": "postgres", "module_path": "packages.db.session", "dependency_type": "required", "description": "All data persistence"},
    {"provider_key": "redis", "module_path": "workers.celery_app", "dependency_type": "required", "description": "Task queue and caching"},
    {"provider_key": "sentry", "module_path": "apps.api.main", "dependency_type": "optional", "description": "Error tracking (initialized on startup if DSN set)"},
    {"provider_key": "gemini_flash", "module_path": "packages.clients.ai_clients.GeminiFlashClient", "dependency_type": "primary", "description": "Standard-tier text generation"},
    {"provider_key": "deepseek", "module_path": "packages.clients.ai_clients.DeepSeekClient", "dependency_type": "primary", "description": "Bulk text scanning / hashtags / SEO"},
    {"provider_key": "gpt_image", "module_path": "packages.clients.ai_clients.GPTImageClient", "dependency_type": "primary", "description": "Hero image generation"},
    {"provider_key": "imagen4", "module_path": "packages.clients.ai_clients.Imagen4Client", "dependency_type": "primary", "description": "Bulk image generation"},
    {"provider_key": "flux", "module_path": "packages.clients.ai_clients.FluxClient", "dependency_type": "optional", "description": "Style variety images"},
    {"provider_key": "runway", "module_path": "packages.clients.ai_clients.RunwayClient", "dependency_type": "primary", "description": "Hero video generation"},
    {"provider_key": "kling", "module_path": "packages.clients.ai_clients.KlingClient", "dependency_type": "primary", "description": "Bulk video generation"},
    {"provider_key": "did", "module_path": "packages.clients.ai_clients.DIDClient", "dependency_type": "fallback", "description": "Budget avatar generation"},
    {"provider_key": "fish_audio", "module_path": "packages.clients.ai_clients.FishAudioClient", "dependency_type": "primary", "description": "Standard voice generation"},
    {"provider_key": "voxtral", "module_path": "packages.clients.ai_clients.VoxtralClient", "dependency_type": "optional", "description": "Ultra-budget voice generation"},
    {"provider_key": "suno", "module_path": "packages.clients.ai_clients.SunoClient", "dependency_type": "primary", "description": "Music generation"},
]
