...
def seed():
    with Session(engine) as db:
        ...
        brand3 = Brand(
            organization_id=org.id, name="Tool Signal", slug="tool-signal",
            niche="AI tools", sub_niche="AI signals & productivity",
        ...
        brand4 = Brand(
            organization_id=org.id, name="Aesthetic Theory", slug="aesthetic-theory",
            niche="aesthetics", sub_niche="modern aesthetics & treatments",
        ...
        brand5 = Brand(
            organization_id=org.id, name="Body Theory", slug="body-theory",
            niche="health & beauty", sub_niche="body treatments & regenerative aesthetics",
        ...
        brand6 = Brand(
            organization_id=org.id, name="Age Fix Daily", slug="age-fix-daily",
            niche="anti-aging", sub_niche="age reversal & longevity treatments",
        ...
        brand7 = Brand(
            organization_id=org.id, name="Velvet Wire", slug="velvet-wire",
            niche="lifestyle & aesthetics", sub_niche="curated lifestyle & beauty",
        ...
        db.add_all([brand1, brand2, brand3, brand4, brand5, brand6, brand7])
        db.flush()
        ...
        # ─── Tool Signal Accounts ─────────────────────────────────────
        ts_x = CreatorAccount(brand_id=brand3.id, platform=Platform.TWITTER, account_type=AccountType.ORGANIC, platform_username="@toolsignal01", niche_focus="AI tools", language="en", geography="US", posting_capacity_per_day=3, scale_role="flagship")
        ts_ig = CreatorAccount(brand_id=brand3.id, platform=Platform.INSTAGRAM, account_type=AccountType.ORGANIC, platform_username="@thetoolsignal", niche_focus="AI tools", language="en", geography="US", posting_capacity_per_day=2, scale_role="flagship")
        ts_tt = CreatorAccount(brand_id=brand3.id, platform=Platform.TIKTOK, account_type=AccountType.ORGANIC, platform_username="@toolsignalai", niche_focus="AI tools", language="en", geography="US", posting_capacity_per_day=3, scale_role="flagship")
        ts_yt = CreatorAccount(brand_id=brand3.id, platform=Platform.YOUTUBE, account_type=AccountType.ORGANIC, platform_username="@toolsignalco-1", niche_focus="AI tools", language="en", geography="US", posting_capacity_per_day=1, scale_role="flagship")
        ts_li = CreatorAccount(brand_id=brand3.id, platform=Platform.LINKEDIN, account_type=AccountType.ORGANIC, platform_username="tool-signal", niche_focus="AI tools", language="en", geography="US", posting_capacity_per_day=1, scale_role="experimental")
        ts_fb = CreatorAccount(brand_id=brand3.id, platform=Platform.FACEBOOK, account_type=AccountType.ORGANIC, platform_username="toolsignaldaily", niche_focus="AI tools", language="en", geography="US", posting_capacity_per_day=1, scale_role="experimental")
        db.add_all([ts_x, ts_ig, ts_tt, ts_yt, ts_li, ts_fb])

        # ─── Aesthetic Theory Accounts ────────────────────────────────
        at_yt = CreatorAccount(brand_id=brand4.id, platform=Platform.YOUTUBE, account_type=AccountType.ORGANIC, platform_username="@theaesthetictheoryco", niche_focus="aesthetics", language="en", geography="US", posting_capacity_per_day=1, scale_role="flagship")
        at_tt = CreatorAccount(brand_id=brand4.id, platform=Platform.TIKTOK, account_type=AccountType.ORGANIC, platform_username="@theaesthetictheoryco", niche_focus="aesthetics", language="en", geography="US", posting_capacity_per_day=2, scale_role="flagship")
        db.add_all([at_yt, at_tt])

        # ─── Body Theory Accounts ─────────────────────────────────────
        bt_tt = CreatorAccount(brand_id=brand5.id, platform=Platform.TIKTOK, account_type=AccountType.ORGANIC, platform_username="@bodytheory.co", niche_focus="body treatments", language="en", geography="US", posting_capacity_per_day=2, scale_role="flagship")
        bt_yt = CreatorAccount(brand_id=brand5.id, platform=Platform.YOUTUBE, account_type=AccountType.ORGANIC, platform_username="@bodytheorydaily", niche_focus="body treatments", language="en", geography="US", posting_capacity_per_day=1, scale_role="flagship")
        bt_fb = CreatorAccount(brand_id=brand5.id, platform=Platform.FACEBOOK, account_type=AccountType.ORGANIC, platform_username="bodytheorydaily", niche_focus="body treatments", language="en", geography="US", posting_capacity_per_day=1, scale_role="flagship")
        db.add_all([bt_tt, bt_yt, bt_fb])
        # NOTE: Body Theory Instagram blocked — Instagram restricting the Gmail. Needs manual resolution.

        # ─── Age Fix Daily Accounts ───────────────────────────────────
        afd_ig = CreatorAccount(brand_id=brand6.id, platform=Platform.INSTAGRAM, account_type=AccountType.ORGANIC, platform_username="@age_fix_daily", niche_focus="anti-aging", language="en", geography="US", posting_capacity_per_day=1, scale_role="flagship")
        db.add_all([afd_ig])

        # ─── Velvet Wire Accounts ─────────────────────────────────────
        vw_ig = CreatorAccount(brand_id=brand7.id, platform=Platform.INSTAGRAM, account_type=AccountType.ORGANIC, platform_username="@velvetwire.co", niche_focus="lifestyle & aesthetics", language="en", geography="US", posting_capacity_per_day=1, scale_role="flagship")
        db.add_all([vw_ig])
        ...
        ts_portfolio = AccountPortfolio(brand_id=brand3.id, name="Tool Signal Portfolio", description="All creator accounts for Tool Signal", strategy="Multi-platform AI tools authority", total_accounts=6)
        at_portfolio = AccountPortfolio(brand_id=brand4.id, name="Aesthetic Theory Portfolio", description="All creator accounts for Aesthetic Theory", strategy="Short-form aesthetics education", total_accounts=2)
        bt_portfolio = AccountPortfolio(brand_id=brand5.id, name="Body Theory Portfolio", description="All creator accounts for Body Theory", strategy="Body treatment education and trust-building", total_accounts=3)
        afd_portfolio = AccountPortfolio(brand_id=brand6.id, name="Age Fix Daily Portfolio", description="All creator accounts for Age Fix Daily", strategy="Anti-aging education and trust-building", total_accounts=1)
        vw_portfolio = AccountPortfolio(brand_id=brand7.id, name="Velvet Wire Portfolio", description="All creator accounts for Velvet Wire", strategy="Curated lifestyle and aesthetics content", total_accounts=1)
        db.add_all([portfolio, ts_portfolio, at_portfolio, bt_portfolio, afd_portfolio, vw_portfolio])
        db.flush()
