...
def build_launch_blueprints_from_commands(
    ...
    for cmd in launch_cmds[:5]:
        ...
        out.append({
            ...
            "monetization_strategy_json": {"path": cmd.get("monetization_path"), "styles": spec.get("monetization_styles")},
            ...
            "first_owned_audience_strategy_json": {"capture": "newsletter_or_sms", "reason": "reduce_rented_audience_risk"},
...
def build_capital_plan(
    ...
    return {
        ...
        "account_budget_mix_json": {"launch": round(total_budget * 0.35, 2), "exploit_winners": round(total_budget * 0.25, 2)},
        ...
        "explanation_json": {"rule": "60/20/10 style split with holdback for optionality", "capital_constrained": capital_constrained},
