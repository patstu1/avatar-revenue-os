...
export default function OfferLabPage() {
  ...
  useEffect(() => { Promise.all([apiFetch(`/api/v1/brands/${brandId}/offer-lab/offers`), apiFetch(`/api/v1/brands/${brandId}/offer-lab/blockers`)]).then(([o, b]) => { setOffers(o); setBlockers(b); }).catch(() => {}).finally(() => setLoading(false)); }, []);
