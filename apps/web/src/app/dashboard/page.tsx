...
function MetricCard({
  ...
  return (
    <div className="bg-gray-900/80 border border-gray-800/60 rounded-xl px-4 py-4 sm:px-5">
      <div className="flex items-start justify-between">
        <div className="min-w-0">
          <p className="text-[11px] font-medium text-gray-500 uppercase tracking-wider">{label}</p>
          <p className="text-xl sm:text-2xl font-bold mt-1 truncate" style={{ color }}>
            {value}
          </p>
