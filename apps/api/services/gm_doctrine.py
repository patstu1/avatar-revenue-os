...
REVENUE_AVENUES: Final[list[dict]] = [
    ...
    },
    {
        "id": "premium_access",
        "n": 4,
        "display_name": "Premium access / membership",
        "status": STATUS_LIVE_BUT_DORMANT,
        "revenue_tables": ["creator_revenue_events"],
    ...
    },
    {
        "id": "owned_affiliate",
        "n": 10,
        "display_name": "Owned affiliate program",
        "status": STATUS_LIVE_BUT_DORMANT,
    ...
    {
        "id": "external_affiliate",
        "n": 11,
        "display_name": "External affiliate partnerships",
    ...
    },
    {
        ...
        "n": 12,
        "display_name": "SaaS subscriptions",
        "status": STATUS_PRESENT_IN_CODE_ONLY,
    ...
    },
    {
        "id": "high_ticket",
        "n": 13,
        "display_name": "High-ticket deals",
        "status": STATUS_LIVE_AND_ACTIVE,
    ...
    {
        "id": "monetization_packs",
        "n": 15,
        "display_name": "Monetization credits / packs / plans",
        "status": STATUS_LIVE_BUT_DORMANT,
    ...
    },
    {
        "id": "sponsor_deals",
        "n": 17,
        "display_name": "Sponsor / brand deals",
    ...
    },
    {
        ...
        "n": 18,
        "display_name": "Recurring revenue / retainers",
        "status": STATUS_LIVE_BUT_DORMANT,
    ...
    },
    {
        "id": "paid_promotion",
        "n": 19,
        "display_name": "Paid promotion / amplification",
        "status": STATUS_LIVE_AND_ACTIVE,
    ...
    },
    {
        "id": "upsell_bundles",
        "n": 20,
        "display_name": "Upsell / cross-sell / downsell / bundles",
        "status": STATUS_LIVE_BUT_DORMANT,
    ...
    },
    {
        "id": "referral",
        "n": 21,
        "display_name": "Referral-driven revenue",
        "status": STATUS_LIVE_BUT_DORMANT,
    ...
    },
    {
        "id": "reactivation",
        "n": 22,
        "display_name": "Reactivation / win-back revenue",
        "status": STATUS_LIVE_BUT_DORMANT,
...
STRATEGIC_ENGINES: Final[list[dict]] = [
    # Portfolio + capital + growth layer
    {
        ...
        "tables": [
            ...
            "geo_language_expansion_recommendations",
    ...
    {
        "id": "revenue_ceiling_a",
        "family": "revenue_ceiling",
        "status": STATUS_LIVE_AND_VERY_ACTIVE,
        "tables": [
            "offer_ladders",
    ...
    {
        "id": "expansion_pack2_a",
        "family": "expansion",
        "status": STATUS_LIVE_AND_ACTIVE,
        "tables": ["lead_opportunities", "closer_actions", "lead_qualification_reports", "owned_offer_recommendations"],
        "purpose": "Lead qualification + closer actions + owned-offer recommendations.",
    },
    {
        "id": "expansion_pack2_b",
        "family": "expansion",
        "status": STATUS_LIVE_AND_ACTIVE,
        "tables": [
    ...
    # Diagnostic + recovery
    {
        ...
        "family": "diagnostic",
        "status": STATUS_LIVE_AND_ACTIVE,
        "tables": ["rld_reports", "rld_events", "rld_clusters", "rld_corrections", "rld_loss_estimates"],
    ...
    },
    {
        ...
        "family": "brain",
        "status": STATUS_LIVE_AND_VERY_ACTIVE,
        "tables": ["agent_registry", "workflow_coordination_runs", "coordination_decisions", "shared_context_events"],
    ...
    {
        "id": "account_state_intel",
        "family": "intelligence",
        "status": STATUS_LIVE_AND_ACTIVE,
        "tables": ["asi_account_state_reports", "asi_account_state_transitions", "asi_account_state_actions"],
    ...
    },
    {
        ...
        "family": "intelligence",
        "status": STATUS_LIVE_AND_ACTIVE,
        "tables": ["dt_simulation_runs", "dt_scenarios", "dt_assumptions", "dt_outcomes", "dt_recommendations"],
    ...
    {
        "id": "mxp_objection_mining",
        "family": "mxp",
        "status": STATUS_PRESENT_IN_CODE_ONLY,
        "tables": ["om_objection_signals", "om_objection_clusters", "om_objection_responses", "om_priority_reports"],
        "purpose": "Objection mining from inbound + competitor data.",
    },
    {
        "id": "mxp_offer_lifecycle",
        "family": "mxp",
        "status": STATUS_LIVE_BUT_DORMANT,
...
CANONICAL_EVENT_TYPES: Final[tuple[str, ...]] = (
    ...
    "gm.approval.rejected",
    "gm.escalation.opened",
    "gm.escalation.resolved",
    "ledger.stripe_checkout",
    "ledger.stripe_invoice_paid",
    "ledger.stripe_refund",
    "ledger.stripe_subscription_created",
...
def classify_action(
    *,
    ...
    if money_involved or custom_scope or high_value or activates_dormant_avenue:
