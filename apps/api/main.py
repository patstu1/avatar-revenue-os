...
app.include_router(gm_write.router, prefix="/api/v1", tags=["GM Write Authority: approvals, escalations, drafts, proposals, payment links, avenue activation, stage marks"])
