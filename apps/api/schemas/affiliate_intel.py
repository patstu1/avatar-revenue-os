...
class AffiliateOfferOut(BaseModel):
    ...
    id: uuid.UUID; product_name: str; product_category: str | None = None; offer_type: str; epc: float; conversion_rate: float; commission_rate: float; trust_score: float; rank_score: float; truth_label: str; blocker_state: str | None = None; is_active: bool

class AffiliateLinkOut(BaseModel):
    model_config = ConfigDict(from_attributes=True)
    id: uuid.UUID; full_url: str; short_url: str | None = None; platform: str | None = None; click_count: int; conversion_count: int; disclosure_applied: bool
