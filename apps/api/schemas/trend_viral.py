...
class TVOpportunityOut(BaseModel):
    model_config = ConfigDict(from_attributes=True)
    id: uuid.UUID; topic: str; source: str; velocity_score: float; novelty_score: float; revenue_potential_score: float; opportunity_type: str; recommended_platform: str | None = None; recommended_content_form: str | None = None; recommended_monetization: str | None = None; urgency: float; confidence: float; composite_score: float; truth_label: str; status: str
