...
async def ingest_performance(
    brand_id: uuid.UUID, body: PerformanceIngestRequest, current_user: OperatorUser, db: DBSession
):
...
async def track_click(
    body: ClickTrackRequest, current_user: CurrentUser, db: DBSession, _rl=Depends(webhook_rate_limit)
):
...
async def track_conversion(
    body: ConversionTrackRequest, current_user: CurrentUser, db: DBSession, _rl=Depends(webhook_rate_limit)
):
