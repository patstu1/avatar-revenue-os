...
def recompute_brain_decisions():
    run_async(_recompute_brain_decisions())
...
def recompute_agent_mesh():
    run_async(_recompute_agent_mesh())
...
def recompute_meta_monitoring():
    run_async(_recompute_meta_monitoring())
